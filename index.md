...
instructor: ["Julia Blum", "Jaxine Wolfe", "Michael Lonneman", "Paula Pappalardo", "James Holmquist"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Rose Cheney"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2025-06-05-SERC)  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
{% elsif site.carpentry == "dc" %}
{% include dc/custom-schedule.html %}
{% elsif site.carpentry == "lc" %}
